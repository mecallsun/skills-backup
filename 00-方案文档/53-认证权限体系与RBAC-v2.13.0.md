...
本项目是基于 .NET 8 + Razor + EF Core 的住宿管理系统，采用 EXE 自托管部署架构。
...
| 角色编码 | 角色名称 | 权限范围 |
|---------|---------|---------|
| `admin` | 管理员 | 全部模块（首页/办理/住宿/人员/账单/抄表/基础/设置） |
| `finance` | 财务 | 首页/费用标准/住宿账单/员工账单/基础资料/系统设置 |
