...
```
┌──────────────────────────────────────────────────────────────┐
│ [Logo] 金戈宿舍管理系统 v2.13.55  [DB]  [👤 管理员]  [退出]   │
│                                              ↑                │
│                                          唯一入口              │
└──────────────────────────────────────────────────────────────┘
```
...
├ 首页 / 办理登记 / 宿舍管理 / 人员清单 / 费用标准 /
├ 宿舍账单 / 员工账单 / 抄表记录 / 基础资料 / 系统设置
│
