...
const EXPECTED_TABS = [
  ...
  { id: 'tab-dorms',         title: '住宿管理',   module: 'dorms',          url: 'dorms/list.html' },
  ...
  { id: 'tab-dorm-bills',    title: '住宿账单',   module: 'dorm-bills',     url: 'billing/dorm-bills.html' },
...
const TEST_PAGES = [
  ...
  { url: 'http://localhost:8765/dorms/list.html',                  expectedActive: 'tab-dorms',         expectedActiveTitle: '住宿管理' },
  { url: 'http://localhost:8765/dorms/create.html',                expectedActive: 'tab-dorms',         expectedActiveTitle: '住宿管理' },
  { url: 'http://localhost:8765/dorms/details.html',               expectedActive: 'tab-dorms',         expectedActiveTitle: '住宿管理' },
  { url: 'http://localhost:8765/dorms/history.html',               expectedActive: 'tab-dorms',         expectedActiveTitle: '住宿管理' },
  ...
  { url: 'http://localhost:8765/billing/dorm-bills.html',          expectedActive: 'tab-dorm-bills',    expectedActiveTitle: '住宿账单' },
