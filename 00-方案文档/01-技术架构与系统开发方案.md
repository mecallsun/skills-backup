...
> 适用环境：Android PDA（工业级）+ Windows Server 2019/Windows 10/11 + .NET 8 Desktop Runtime + SQL Server 2017/2019
...
| **Web API 服务端** | **.NET 8 ASP.NET Core WebAPI + 自托管 Kestrel（EXE）** | .NET 8 进程内自带 Kestrel 服务器，发布为单个 EXE，无需 IIS 即可对外提供 HTTP 服务。Windows Server 2019 / Windows 10/11 安装 .NET 8 Desktop Runtime 即可运行。 |
...
| **数据库** | **SQL Server 2017/2019**（或 SQL Server Express 免费版） | 与 .NET 生态最契合，SSMS 管理工具成熟，索引/全文检索/触发器完整。 |
...
## 19. 人员清单管理（Personnel Management）
