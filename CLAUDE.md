...
- **项目当前版本：** v2.13.64（2026-07-21 系统设置 用户管理 P0 修复 + 1:1 原型对齐 — UserController 添加 /enable 和 /disable 端点、DeleteUser 级联清理 4 子表、User.cshtml 添加搜索/角色/状态筛选 + 分页、编辑 Modal 角色回显改用 RoleIds Id 严格匹配）
