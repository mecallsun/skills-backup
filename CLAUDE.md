...
- **项目当前版本：** v2.13.82（2026-07-21 宿舍档案「启用状态」在宿人数锁定约束 — CurrentCount > 0 时禁止停用宿舍，三层防御 UI 复选框 disabled + PageModel 校验 + API `DORM_HAS_RESIDENTS` 拒绝；详见 `00-方案文档/133-宿舍档案启用状态在宿人数锁定约束-v2.13.82.md`）
