...
BEGIN
    ...
    VALUES
        (1,  'EMP-2026-001', N'张三', 1, N'生产部', 1, N'合同工', 1, 1, '13800000001', 1, 1, '2025-01-15', 1, 'D-001', N'A班',  1, 2, 1, GETDATE()),
        (2,  'EMP-2026-002', N'李四', 2, N'技术部', 1, N'合同工', 2, 1, '13800000002', 1, 1, '2025-02-20', 1, 'D-002', N'B班',  1, 4, 1, GETDATE()),
        (3,  'EMP-2026-003', N'王五', 3, N'行政部', 1, N'合同工', 3, 2, '13800000003', 1, 1, '2024-06-10', 1, 'D-003', N'C班',  1, 1, 1, GETDATE()),
        (4,  'EMP-2026-004', N'赵六', 2, N'技术部', 2, N'临时工', 4, 1, '13800000004', 1, 1, '2025-03-01', 1, 'D-004', N'D班',  1, 2, 1, GETDATE()),
        (5,  'EMP-2026-005', N'孙七', 1, N'生产部', 1, N'合同工', 1, 1, '13800000005', 1, 1, '2024-11-05', 2, 'D-001', N'A班',  1, 3, 1, GETDATE()),
        (6,  'EMP-2026-006', N'周八', 4, N'财务部', 1, N'合同工', 2, 2, '13800000006', 1, 1, '2025-04-15', 2, 'D-002', N'B班',  1, 1, 1, GETDATE()),
        (7,  'EMP-2026-007', N'吴九', 5, N'销售部', 3, N'外包',   3, 1, '13800000007', 1, 1, '2024-09-20', 1, 'D-003', N'C班',  1, 2, 1, GETDATE()),
        (8,  'EMP-2026-008', N'郑十', 2, N'技术部', 1, N'合同工', 4, 1, '13800000008', 1, 1, '2025-01-08', 2, 'D-004', N'D班',  1, 4, 1, GETDATE()),
        (9,  'EMP-2026-009', N'钱一', 6, N'后勤部', 1, N'合同工', 1, 1, '13800000009', 1, 1, '2024-12-01', 1, 'D-005', N'A班',  1, 1, 1, GETDATE()),
...
BEGIN
    ...
    VALUES
        (1,  1, 'EMP-2026-001', N'张三', '13800000001', N'生产部', 2, 'D-001', 1, '2025-01-15', 2, N'入职', '2025-01-15 10:00:00', 'admin', 1, GETDATE()),
        (2,  2, 'EMP-2026-002', N'李四', '13800000002', N'技术部', 4, 'D-002', 1, '2025-02-20', 2, N'入职', '2025-02-20 14:30:00', 'admin', 1, GETDATE()),
        (3,  3, 'EMP-2026-003', N'王五', '13800000003', N'行政部', 1, 'D-003', 1, '2024-06-10', 2, N'入职', '2024-06-10 09:15:00', 'admin', 1, GETDATE()),
        (4,  4, 'EMP-2026-004', N'赵六', '13800000004', N'技术部', 2, 'D-004', 1, '2025-03-01', 2, N'入职', '2025-03-01 11:00:00', 'admin', 1, GETDATE()),
        (5,  5, 'EMP-2026-005', N'孙七', '13800000005', N'生产部', 3, 'D-001', 1, '2024-11-05', 2, N'调宿', '2024-11-05 16:20:00', 'admin', 1, GETDATE()),
        (6,  6, 'EMP-2026-006', N'周八', '13800000006', N'财务部', 1, 'D-002', 1, '2025-04-15', 2, N'入职', '2025-04-15 10:45:00', 'admin', 1, GETDATE()),
        (7,  7, 'EMP-2026-007', N'吴九', '13800000007', N'销售部', 2, 'D-003', 1, '2024-09-20', 2, N'入职', '2024-09-20 13:30:00', 'admin', 1, GETDATE()),
        (8,  8, 'EMP-2026-008', N'郑十', '13800000008', N'技术部', 4, 'D-004', 1, '2025-01-08', 2, N'入职', '2025-01-08 08:00:00', 'admin', 1, GETDATE()),
        (9,  9, 'EMP-2026-009', N'钱一', '13800000009', N'后勤部', 1, 'D-005', 1, '2024-12-01', 2, N'入职', '2024-12-01 15:00:00', 'admin', 1, GETDATE()),
        (10, 1, 'EMP-2026-001', N'张三', '13800000001', N'生产部', 2, 'D-001', 2, '2025-06-30', 3, N'离职', '2025-06-30 17:00:00', 'admin', 1, GETDATE());
